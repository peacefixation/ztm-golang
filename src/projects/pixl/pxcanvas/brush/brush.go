...
func Cursor(config apptype.PxCanvasConfig, brush apptype.Brush, ev *desktop.MouseEvent, x, y int) []fyne.CanvasObject {
	...
	case brush == Pixel:
		...
		cursorColor := color.NRGBA{80, 80, 80, 255} // dark grey
